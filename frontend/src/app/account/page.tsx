...
const Account = () => {
  ...
  const activeTab = useMemo<Tab>(() => {
    if (pathname === "/account/history") return "history";
    if (pathname === "/account/following") return "following";
    return "none";
  }, [pathname]);
            ...
            <div className="relative pt-16 pb-10 px-6 text-center overflow-hidden">
              ...
              >
                ...
                <div className="flex items-center justify-center gap-10 mt-8 w-full max-w-sm mx-auto">
                  <button onClick={() => router.push("/favorites")} className="text-center group active:scale-95 transition-transform">
                  ...
                  <button onClick={() => router.push("/account/following")} className="text-center group active:scale-95 transition-transform">
                ...
                followedList.length > 0 ? (
                  <div className="space-y-3">
                    {followedList.map((f) => (
                      <button 
                        key={f.artist_slug} 
                        onClick={() => router.push(`/profile/${f.id || f.artist_slug}`)}
